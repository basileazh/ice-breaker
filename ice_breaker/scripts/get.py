...
def get(
    name_search: str,
    linkedin_profile_json: Optional[str] = None,
    # twitter_profile_json: Optional[str] = None
) -> str:
    """
    ...
    :param name_search: Name for the LinkedIn profile to be found. Other elements may be added to it,
